...
class StatusFAB extends StatelessWidget {
  ...
  final isLoading;
  final Future<void> Function() fetchUserStatus;
  ...
  const StatusFAB({super.key, required this.statuses, required bool this.isLoading, required this.fetchUserStatus});
  ...
  void _showAddStatusModal(BuildContext context, StatusFormViewModel vm) {
    showModalBottomSheet(
      ...
      builder: (context) {
        return StatusForm(statuses: statuses, vm: vm, isLoading: isLoading,  onSubmitSuccess: fetchUserStatus,);
      },
    );
  }
}
